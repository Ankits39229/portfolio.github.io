      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
              Featured Web Development Projects
            </h2>
            <p className="text-neutral-300 max-w-2xl mx-auto leading-relaxed">
              Showcasing modern web applications built with cutting-edge technologies and innovative solutions.
            </p>
          </div>
          ...
          <div className="space-y-12">
            {projects.map((project, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:border-blue-400/40 transition-all duration-500 group"
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                    <div className="flex items-center gap-4 mb-6">
                      <div className="flex items-center gap-3">
                        <span className="text-3xl font-bold text-blue-400/60">0{index + 1}</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                      <div>
                        <h4 className="font-bold mb-4 text-blue-400 flex items-center gap-2">
                          <Star size={18} />
                          Key Features
                        </h4>
                        <ul className="text-neutral-300 space-y-3">
                          {project.features.slice(0, 4).map((feature, idx) => (
                            <li key={idx} className="flex items-start gap-3 group/item">
                              <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 flex-shrink-0 group-hover/item:scale-125 transition-transform duration-300" />
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.technologies.map((tech, idx) => (
                            <span 
                              key={tech} 
                              className="px-3 py-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 text-blue-300 rounded-xl text-sm font-medium border border-blue-500/30 hover:border-blue-400/50 hover:from-blue-500/30 hover:to-cyan-500/30 transition-all duration-300 cursor-default"
                    ...
                    <div className="flex gap-4">
                      {project.liveUrl && (
                        <a
                          ...
                          className="flex items-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25"
                        >
                  ...
                  <div className={`relative ${index % 2 === 1 ? "lg:order-1" : ""}`}>
                    ...
                    {/* Floating Elements */}
                    <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-blue-400/20 to-cyan-400/20 rounded-full backdrop-blur-sm border border-blue-400/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                      <span className="text-blue-400 font-bold">{project.difficulty}</span>
                    </div>
                  </div>
                </div>
              </motion.div>
